# This code is Peter Hinch's code with minimal adjustments for CircuitPython by Filip Ginter
    ...
    def __init__(self, timediff):
        if timediff is None:
            ...
            if is_micropython:
                ...
                self.timediff = lambda start, end: (start-end)/1000000000.0 # FG: we have monotonic ns, so this is as simple as doing a minus without any wrap-over
